...
StaticMesh::MeshTexture::MeshTexture(const std::string& FileName)
{
	//	m_textureTarget = TextureTarget;
	m_fileName = FileName;
}

bool StaticMesh::MeshTexture::Load(ID3D11Device* device, aiScene* pScene, aiMaterial* material)
{
...
void StaticMesh::MeshEntry::Init(ID3D11Device* device)
{
...
bool StaticMesh::Init(ID3D11Device * d3d11device)
{
	device = d3d11device;
	DWORD shaderFlags = 0;
...
bool StaticMesh::InitMeshFromScene(const aiScene* pScene, const std::string& Filename)
{
...
void StaticMesh::InitMesh(unsigned int MeshIndex, const aiMesh* paiMesh)
{
...
void StaticMesh::Render(ID3D11DeviceContext*& md3dImmediateContext)
{
...
void StaticMesh::_updateBoundsFromVertexBuffers(bool pad)
{
}

void StaticMesh::_calcBoundsFromVertexBuffer(AxisAlignedBox & outAABB, Real & outRadius, bool updateOnly)
{
}
