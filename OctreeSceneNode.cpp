...
OctreeSceneNode::OctreeSceneNode(const std::string& name)
	:mParent(0),
...
OctreeSceneNode * OctreeSceneNode::createChildImpl(const std::string & name)
{
	return nullptr;
}
...
OctreeSceneNode * OctreeSceneNode::createChild(const std::string & name, const Vector3 & translate, const Quaternion & rotate)
{
...
void OctreeSceneNode::addChild(OctreeSceneNode * child)
{
	...
	typedef std::pair<std::string, OctreeSceneNode*> nodepair;
...
OctreeSceneNode * OctreeSceneNode::getChild(const std::string & name) const
{
...
OctreeSceneNode * OctreeSceneNode::removeChild(const std::string & name)
{
