...
void SkinnedMesh::_updateBoundsFromVertexBuffers(bool pad)
{
}
void SkinnedMesh::_calcBoundsFromVertexBuffer(AxisAlignedBox & outAABB, Real & outRadius, bool updateOnly)
{
}
